...
Install the `building-secure-contracts` skill from Trail of Bits when the first Solidity code lands (S1.2). Do NOT install it in this spec — there is no Solidity code to analyze yet.
...
- claude-code-security-review Action — install alongside Trail of Bits skills at S1.2+
